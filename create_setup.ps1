...
"@ | Out-File -FilePath "commandments/__init__.py" -Encoding UTF8NoBOM
...
"@ | Out-File -FilePath "setup.py" -Encoding UTF8NoBOM
...
"@ | Out-File -FilePath "examples/smart_loan.py" -Encoding UTF8NoBOM
...
"@
'@ | Out-File -FilePath "setup_minimal.ps1" -Encoding UTF8NoBOM

Write-Host "Created setup_minimal.ps1. Now run: .\setup_minimal.ps1"