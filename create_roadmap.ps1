...
'@ | Out-File -FilePath "ROADMAP.md" -Encoding ASCII

# Update README to include roadmap link
$roadmapContent = @'
...
Add-Content -Path "README.md" -Value $roadmapContent
...
Write-Host "Project roadmap has been created and pushed to the repository"